...
//                  email: techsupport@latticesemi.com-----------
	   ...
	   PARALLEL TO MIPI CSI2 Sensor Bridge Design Readme
-------------------------------------------------------------------------
---------------------------------------------------------------------------
...
1.  ..\docs\readme.txt                                                        -->  read me file (this file)
    ..\docs\rd1183.pdf                                                        -->  Parallel to MIPI CSI2 TX Bridge reference document
...
3. ..testbench\Parallel2CSI2_tb_*lane.v                                       -->  TestBench for parallel to MIPI CSI2 TX design
...
4.  ..imp\Parallel2CSI2.ldf                                                   -->  Diamond project file for  MIPI csi2 tx design
    ..imp\Parallel2CSI2.lpf                                                   -->  constraint file for  MIPI csi2 tx design
    ..imp\Parallel2CSI2.sty                                                   -->  strategy file for  MIPI csi2 tx design
