...
/* Module Version: 5.7 */
/* D:\FPGA\Lattice\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_pix2byte_YUV422_8bit_1lane -lang verilog -synth synplify -arch xo2c00 -type pll -fin 27 -fclkop 108 -fclkop_tol 0.0 -fclkos 108 -fclkos_tol 0.0 -fclkos2 27 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Thu Feb 22 18:39:25 2018 */


`timescale 1 ns / 1 ps
module pll_pix2byte_YUV422_8bit_1lane (CLKI, RST, CLKOP, CLKOS, CLKOS2, 
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="27.000000" */
             /* synthesis FREQUENCY_PIN_CLKOS="108.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 27.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 108.000000
