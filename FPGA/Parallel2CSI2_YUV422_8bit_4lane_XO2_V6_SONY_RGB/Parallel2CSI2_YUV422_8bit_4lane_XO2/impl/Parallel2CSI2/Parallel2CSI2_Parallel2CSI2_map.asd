...
EBR_used = 2;
; Begin EBR Section
Instance_Name = u_BYTE_PACKETIZER/u_parallel2byte/u_fifo/pixel2byte_fifo_8to32_0_1;
Type = FIFO8KB;
Width = 16;
REGMODE = NOREG;
RESETMODE = ASYNC;
...
GSR = DISABLED;
Instance_Name = u_BYTE_PACKETIZER/u_parallel2byte/u_fifo/pixel2byte_fifo_8to32_1_0;
Type = FIFO8KB;
Width = 16;
REGMODE = NOREG;
RESETMODE = ASYNC;
...
; End EBR Section
; Begin PLL Section
Instance_Name = u_sony_block_to_yuv422_csi/plldoubler/PLLInst_0;
Type = EHXPLLJ;
...
CLKOP_Desired_Phase_Shift(degree) = 90;
...
Instance_Name = u_pll_pix2byte_YUV422_8bit_4lane/PLLInst_0;
Type = EHXPLLJ;
CLKOP_Post_Divider_A_Input = DIVA;
CLKOS_Post_Divider_B_Input = DIVB;
CLKOS2_Post_Divider_C_Input = DIVC;
