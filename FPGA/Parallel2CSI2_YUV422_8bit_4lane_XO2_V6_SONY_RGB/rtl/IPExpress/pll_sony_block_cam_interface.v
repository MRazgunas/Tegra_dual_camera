...
/* Module Version: 5.7 */
/* D:\FPGA\Lattice\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_sony_block_cam_interface -lang verilog -synth synplify -arch xo2c00 -type pll -fin 75 -fclkop 150 -fclkop_tol 0.0 -fclkos 150 -fclkos_tol 0.0 -trimp 0 -phasep 90 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 2  */
/* Sat Feb 24 14:43:21 2018 */


`timescale 1 ns / 1 ps
module pll_sony_block_cam_interface (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    ...
    defparam PLLInst_0.CLKOP_FPHASE = 6 ;
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 150.000000
